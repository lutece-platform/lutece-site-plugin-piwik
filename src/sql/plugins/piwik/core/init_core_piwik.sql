...
('PIWIK_MANAGEMENT','piwik.adminFeature.ManagePiwik.name',1,'jsp/admin/plugins/piwik/Piwik.jsp','piwik.adminFeature.ManagePiwik.description',0,'piwik',NULL,NULL,NULL,4);
